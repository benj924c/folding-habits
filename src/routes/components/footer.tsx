  ...
  return (
    <footer class="footer footer-center p-10 bg-base-200 text-base-content rounded w-full justify-self-end">
      <div class="flex flex-col sm:flex-row gap-4">
        <a href="/use-of-icons" class="link link-hover">
          Use of Icons
        </a>
        <a href="/roadmap" class="link link-hover">
          Roadmap
        </a>
        <a href="https://refold.la/" target="_blank" class="link link-hover">
          Refold
        </a>
      ...
      <div>
        <a
          ...
          href="https://ko-fi.com/juicybenjamin"
          target="_blank"
        >
          <Image
            width="223"
